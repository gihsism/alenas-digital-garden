  ...
  return (
    <section className="min-h-[70vh] flex items-center justify-center px-6 pt-24 pb-12">
      <div className="max-w-4xl mx-auto text-center">
        <p className="font-body text-[10px] tracking-[0.3em] uppercase text-muted-foreground mb-6 animate-fade-up">
          Personal website of
        </p>
        ...
        <p className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: '0.4s' }}>
          Finance & Accounting · AI · Product Owner
        </p>
        ...
        <nav className="mt-4 flex flex-wrap justify-center gap-8 font-body text-sm tracking-wider uppercase animate-fade-up" style={{ animationDelay: '0.5s' }}>
          ...
          <a href="#ventures" className="text-muted-foreground hover:text-accent transition-colors duration-300">Passion Project</a>
