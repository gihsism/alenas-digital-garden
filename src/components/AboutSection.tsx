    ...
    <section id="about" className="px-6 pt-12 pb-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            I grew up in Russia during the turbulent 1990s and early 2000s — a period of deep economic instability and uncertainty that shaped my resilience and drive from an early age. At every turning point, I chose to go deeper rather than stay comfortable — from chemistry at high school (nine hours a week of it), to sociology and then finance at university, to working in PR and product management during my university years, to building a career in external financial audit across multiple countries, and most recently into machine learning and AI. I didn't drift between fields — I sought them out, dove in, and made each one my own.
          </p>
          <p>
