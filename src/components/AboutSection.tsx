    ...
    <section id="about" className="px-6 pt-12 pb-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            I grew up in Russia during the turbulent 1990s and early 2000s — a time that forged my resilience and ambition early on. I've always had the drive to master whatever I set my mind to: chemistry at high school (nine hours a week), sociology and finance at university, PR and product management on the side, leading external financial audit teams across multiple countries, and now applying machine learning and AI in my work and ventures.
          </p>
          <p>
