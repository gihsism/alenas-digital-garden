    ...
    <section id="about" className="px-6 pt-12 pb-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            I grew up in Russia during the turbulent 1990s and early 2000s — a time that forged my resilience and ambition early on. Each step in my career built on the last: a rigorous science education at high school gave me analytical discipline, sociology taught me how organisations and people work, finance showed me how value is created and measured, hands-on PR and product management during university sharpened my business instincts, and years of external financial audit across three countries — with long hours, overtime, and studying for professional accounting qualifications on the side — deepened my expertise in the finance function from every angle. Now, with machine learning and AI, I'm combining all of these into what I do next.
          </p>
          <p>
            I trained as an auditor at KPMG Moscow, and after Russia's annexation of Crimea I moved abroad — working for KPMG in Bristol and then Zurich, earning my ACCA qualification and Swiss Audit License along the way. I hold a BSc in Finance from the Higher School of Economics and an MSc in Sociology from Lomonosov Moscow State University. In 2024, I completed a{" "}
