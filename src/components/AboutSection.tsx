      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            . I advise corporates — often at CFO and board level — on complex financial reporting challenges: IFRS, US GAAP, and Swiss GAAP FER conversions, IPO readiness assessments, M&A accounting (including valuations, pro forma financials, and carve-out statements), and the implementation of new standards like IFRS 18. Whether it's guiding a client through a transaction, designing accounting policies, or standing up a finance function from scratch — the breadth of my experience means I can step into a CFO, Head of Finance, or VP Finance role and lead from day one.
          </p>
          <p>
