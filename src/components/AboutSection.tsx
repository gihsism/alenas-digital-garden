      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            <a href="https://www.hitachienergy.com/" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-foreground transition-colors underline underline-offset-4 font-medium">Hitachi Energy</a>, where I led a global US GAAP-to-IFRS conversion across 120+ entities and pioneered the development of an internal AI accounting chatbot — a project that deepened my passion for product thinking and AI.
          </p>
          <p>
