    ...
    <section id="about" className="px-6 pt-12 pb-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            I grew up in Russia during the turbulent 1990s and early 2000s — a period of deep economic instability and uncertainty that shaped my resilience and drive from an early age. I've always been drawn to learning new things and reinventing myself: I started with chemistry at school, then pivoted to sociology for my first degree, worked in PR and product management during my studies, before diving into audit across multiple countries — and most recently, into machine learning and AI.
          </p>
          <p>
