      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            . I advise corporates at CFO and board level on their most complex financial reporting challenges — GAAP conversions, IPO readiness, M&A accounting, and the implementation of new accounting standards. From complex transaction analysis to standing up entire finance functions, my work covers the full scope of strategic finance — from complex transaction analysis to standing up entire finance functions.
          </p>
          <p>
